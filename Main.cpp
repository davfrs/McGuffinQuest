...
int main() {
	{
		...
		auto itemList = enemyInv.makeEmptyItemListVector();
		itemList.push_back((*new MoneyItem(5000))());
		itemList.push_back((*new WeaponItem("axe1", 1, 10))());
		itemList.push_back((*new WeaponItem("axe2", 2, 50))());
		itemList.push_back((*new ArmorItem("paper armor", 1, 50))());
		itemList.push_back((*new ArmorItem("iron armor", 2, 200))());
